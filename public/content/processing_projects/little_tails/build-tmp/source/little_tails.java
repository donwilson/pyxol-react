...
public class little_tails extends PApplet {
...
class Tail {
	...
	public int colorAt(float cax, float cay) {
		return color(
	...
	public void draw() {
		...
		float min_x = PApplet.parseFloat(width);
		float min_y = PApplet.parseFloat(height);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "little_tails" };
    if (passedArgs != null) {
