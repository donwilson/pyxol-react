...
public class triangle_cube extends PApplet {
...
public int calcColor(float distance, int which_t) {
...
public void draw() {
	...
	for(int t = 0; t < 3; t++) {
		...
		for(int i = 0; i < num_tris; i++) {
			...
			float stroke_weight = (PApplet.parseFloat(i) + 1);
...
/*void mouseWheel(MouseEvent event) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "triangle_cube" };
    if (passedArgs != null) {
